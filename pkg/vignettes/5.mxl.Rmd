...
- it's often the case that one wants to impose that the
  ...
  argument of `mlogit.data`.^[See Section
    \@ref(sec:dataman).],
...
The results are presented in Table~\@ref(tab:risktr).
...
figure~\@ref(fig:plotindpar) the empirical density of VSL for African
and non-African travelers \citep[as done in][Table 4, p.219 and Figure
5, p.223]{LEON:MIGU:17}.

...
[see @TRAI:03 chapter 9] should be used (`NA` and `NULL` indicate
...
distribution, using quantiles for African and non-African travelers
\citep[as done in][Table 4, p.219]{LEON:MIGU:17}.

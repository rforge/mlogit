...
@TRAI:03 ; the theoretical parts of this paper draw heavily on this
book.]
...
[formula/data](./2.formula.data.html) explains how the usual
...
[random utility models](./3.rum.html) describe the landmark
multinomial logit model. Vignette [relaxing the iid
hypothesis](./4.relaxiid.html), [mixed logit model](./5.mxl.html) and
[multinomial probit model](./6.mprobit.html) present three important
extensions of this basic model: Vignette [relaxing the iid
hypothesis](./4.relaxiid.html) presents models that relax the iid
Gumbel hypothesis, [mixed logit model](./5.mxl.html) introduces slope
heterogeneity by considering some parameters as random and
[multinomial probit model](./6.mprobit.html) relax the Gumbel
